...
/// For calculating the static evaluation of a board,
/// done through incremental updates.
/// This is achieved by calculating the static diff generated by a move
/// -> new evaluation is old evaluation + diff from the move


// pub fn incremental_evaluation(
//     board: &Board,
//     chess_move: ChessMove,
//     old_evaluation: BoardEvaluation,
// ) -> BoardEvaluation {
//     let new_board = board.make_move_new(chess_move);
//     let our_color = board.side_to_move();
//
//     if new_board.status() == BoardStatus::Checkmate {
//         return match our_color { // side to move checkmates with this move
//             Color::White => BoardEvaluation::WhiteMate(0),
//             Color::Black => BoardEvaluation::BlackMate(0),
//         };
//     }
//
//     if new_board.status() == BoardStatus::Stalemate {
...
//         if source_piece == Piece::Pawn && to_square == en_passant_square {
...
//     }
//
//     // negate score if moving player is black
//     if our_color == Color::Black {
//         result = -result;
//     }
//
//     // This can't check for calculations like Blackmate(4) -> WhiteMate(2)
...
pub fn incremental_evaluation(
    ...
    if let Some(en_passant_square) = ep_square  {
        ...
        // old en passant logic: wrong
        // if source_piece == Piece::Pawn && to_square == en_passant_square {
        //     println!("en_passant_square {:?}", en_passant_square);
        //     println!("source_piece {:?}", source_piece);
